        ...
        if (filters.isEmpty()) {
            ...
            for (MealPlan meal : allMeals) {
                ...
                for (String filter : filters) {
                    String normalizedFilter = filter.toLowerCase().trim().replace("-", "").replace(" ", "");
                    for (String dietType : mealDietTypes) {
                        String normalizedDietType = dietType.replace("-", "").replace(" ", "");
                        if (normalizedDietType.equals(normalizedFilter)) {
                            matchesFilter = true;
                            break;
                        }
                    }
